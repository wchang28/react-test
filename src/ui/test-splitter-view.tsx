        ...
        <TestingPane>
            ...
            <FontSizeColorTestingWrapper fontSize={fontSize}>
                <div style={{height: `${testAreaHeightPx}px`}}>
                    <SplitterView direction="vertical" splitterSizePx={splitterWidthPx} defaultFirstPaneSizePct={20}>
                        <ScrollView>
                            <div className="w3-khaki" style={{width:"300px", height:"2000px"}}>
                                First Pane
                            </div>
                        </ScrollView>
                        <SplitterView direction="horizontal" defaultFirstPaneSizePct={75} splitterSizePx={splitterWidthPx}>
                            <ScrollView>
